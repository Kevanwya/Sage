...
$check_sql = "SELECT * FROM questions WHERE id = ? AND user_id = ?";
...
if($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if(empty($title_err) && empty($subject_err) && empty($content_err)) {
        ...
        $sql = "UPDATE questions SET title = ?, subject = ?, content = ? WHERE id = ? AND user_id = ?";
        
        if($stmt = mysqli_prepare($conn, $sql)) {
            // Bind variables to the prepared statement as parameters
            mysqli_stmt_bind_param($stmt, "sssii", $param_title, $param_subject, $param_content, $param_id, $param_user_id);
            ...
            if(mysqli_stmt_execute($stmt)) {
                ...
                // Set success message
                $success_msg = "Your question has been updated successfully! Redirecting to the question page...";
    ...
    <div class="dashboard">
        ...
        <main class="main-content">
            ...
            <div class="question-form-container">
                ...
                <form class="question-form" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"] . "?id=" . $question_id); ?>" method="post" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                        ...
                        <div class="current-attachments">
                            <h4>The following files are already attached to your question:</h4>
                    ...
                    <div class="form-buttons">
                        <a href="view_question.php?id=<?php echo $question_id; ?>" class="btn btn-secondary">Cancel</a>
